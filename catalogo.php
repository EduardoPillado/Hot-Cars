...
$sql = $con->prepare("SELECT pk_producto,nombre, precio,foto FROM producto WHERE estatus=1");
$sql->execute();
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@800&display=swap" rel="stylesheet">
  ...
  <body style="background-color: whitesmoke;">
    <h2 style="text-align: center;font-size: 35px; font-family: Open sans;">Catálogo de productos</h2>
    <hr>
