...
$sql = $con->prepare("SELECT pk_producto,nombre, precio, descuento FROM producto WHERE pk_producto=? AND estatus=1");
$sql->execute([$clave]);
$row_prod = $sql->fetch(PDO::FETCH_ASSOC);
       ...
       $sql_insert = $con->prepare("INSERT INTO detalle_compra (fk_compra,fk_producto,nombre,precio,cantidad) VALUES (?,?,?,?,?)");
