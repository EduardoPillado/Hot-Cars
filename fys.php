...
$sql = $con->prepare("SELECT * FROM producto p INNER JOIN  tipo t ON  p.fk_tipo=t.pk_tipo WHERE p.fk_tipo=1");
$sql->execute();
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@800&display=swap" rel="stylesheet">
  ...
  <body style="background-color: whitesmoke;">
     <h2 style="text-align: center;font-size: 35px; font-family: Open sans;">Vehiculos > Fast and furious</h2>
    <hr>
...
<ul class="dropdown-menu">
        ...
        <li><a href="monster_trucks.php" class="dropdown-item">Monster trucks</a></li>
         <hr>
        <li><a href="fys.php" class="dropdown-item nav-link active">Fast and furious</a></li>
