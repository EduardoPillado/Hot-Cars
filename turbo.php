...
$sql = $con->prepare("SELECT * FROM producto p INNER JOIN  tipo t ON  p.fk_tipo=t.pk_tipo WHERE p.fk_tipo=3");
$sql->execute();
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@800&display=swap" rel="stylesheet">
  ...
  <body style="background-color: whitesmoke;">
      <h2 style="text-align: center;font-size: 35px; font-family: Open sans;">Vehiculos > Turbo</h2>
    <hr>
...
<ul class="dropdown-menu">
        ...
        <li><a href="turbo.php" class="dropdown-item nav-link active">Turbo</a></li>
