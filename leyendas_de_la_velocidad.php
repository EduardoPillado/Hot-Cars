...
$sql = $con->prepare("SELECT * FROM producto p INNER JOIN  tipo t ON  p.fk_tipo=t.pk_tipo WHERE p.fk_tipo=6");
$sql->execute();
...
<head>
	...
	<title>Leyendas de la velocidad</title>
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@800&display=swap" rel="stylesheet">
  ...
  <body style="background-color: whitesmoke;">
     <h2 style="text-align: center;font-size: 35px; font-family: Open sans;">Vehiculos > Legends of speed</h2>
    <hr>
...
<ul class="dropdown-menu">
        ...
        <li><a href="monster_trucks.php" class="dropdown-item">Monster trucks</a></li>
         <hr>
            <li><a href="fys.php" class="dropdown-item">Fast and furious</a></li>
        <li><a href="leyendas_de_la_velocidad.php" class="dropdown-item nav-link active">Legends of speed</a></li>
