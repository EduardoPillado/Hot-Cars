...
$sql = $con->prepare("SELECT * FROM producto p INNER JOIN  tipo t ON  p.fk_tipo=t.pk_tipo INNER JOIN categoria c ON t.fk_categoria = c.pk_categoria WHERE t.fk_categoria=1");
$sql->execute();
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@800&display=swap" rel="stylesheet">
  ...
  <body style="background-color: whitesmoke;">
      <h2 style="text-align: center;font-size: 35px; font-family: Open sans;">Vehiculos</h2>
    <hr>
...
<ul class="dropdown-menu">
        <li><a href="vehiculos.php" class="dropdown-item nav-link active">Vehiculos</a></li>
